...
const createbookingusecase = new CreateBookingUseCase(bookingRepo, walletRepo, packageRepo, travelPostDestinationRepo, notificationservice, emailService, userRepository, vendorRepo)
...
const completedTripusecase = new CompleteTripUseCase(walletRepo, bookingRepo, packageRepo, userRepository, vendorRepo)
